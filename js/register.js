        ...
        try {
            ...
            if (tipoUsuario === 'persona') {
                ...
                data = {
                    ...
                    registro_fiscal: document.getElementById('registro_fiscal').value,
...
function validarCampos(tipoUsuario) {
    ...
    const camposEmpresa = ['nombre_empresa', 'razon_social', 'registro_fiscal', 'direccion', 'telefono_empresa'];
